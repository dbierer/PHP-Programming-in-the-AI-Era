...
class City extends GeoBase
{
    ...
    public string $feature_class = ''; // see http////www.geonames.org/export/codes.html, char(1)
    public string $feature_code = ''; // see http////www.geonames.org/export/codes.html, varchar(10)
